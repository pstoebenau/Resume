...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p5 = element("p");
    			a = element("a");
    			a.textContent = "www.pstoebenau.ml";
    			t15 = space();
    			div7 = element("div");
    			attr_dev(p0, "id", "name");
    			...
    			if (!src_url_equal(img3.src, img3_src_value = "./images/web.svg")) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "alt", "portfolio website");
    			attr_dev(img3, "class", "svelte-11uxr4x");
    			add_location(img3, file$3, 23, 6, 654);
    			attr_dev(a, "href", "https://pstoebenau.ml");
    			add_location(a, file$3, 24, 9, 716);
    			attr_dev(p5, "class", "svelte-11uxr4x");
    			add_location(p5, file$3, 24, 6, 713);
    			...
    			add_location(div7, file$3, 27, 2, 796);
    ...
    var data = { Objective:"Skilled developer in web development and Java and Python development that can easily adapt to different workflows. Passionate about clean and reusable code.",
      ...
      Experience:[ { name:"Amazing Voice",
        ...
        { name:"Project AVA",
          ...
          dateRange:"March 2021 - Present",
          description:[ "Partnered with Vū Studios to reimagine camera tracking",
            "Worked with Jetson Nano and multiple SLAM algorithms" ] },
        { name:"Chill Chili",
    ...
    /* src/components/SideSection.svelte generated by Svelte v3.48.0 */
    ...
    /* src/components/MainSection.svelte generated by Svelte v3.48.0 */
    ...
    function create_each_block_2(ctx) {
    	...
    	let a;
    	let p0;
    	let t0_value = /*experience*/ ctx[10].name + "";
    	let t0;
    	let t1;
    	let img;
    	let img_src_value;
    	let t2;
    	let p1;
    	let t3_value = /*experience*/ ctx[10].location + "";
    	let t3;
    	let t4;
    	let div1;
    	let i;
    	let t5_value = /*experience*/ ctx[10].role + "";
    	let t5;
    	let t6;
    	let p2;
    	let t7_value = /*experience*/ ctx[10].dateRange + "";
    	let t7;
    	let t8;
    	let ul;
    	let t9;
    	let each_value_3 = /*experience*/ ctx[10].description;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*experiences*/ 1) {
    				each_value_3 = /*experience*/ ctx[10].description;
    				validate_each_argument(each_value_3);
    				let i;
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			add_location(p, file$1, 72, 12, 2180);
    			attr_dev(div, "class", "flex-around svelte-fqmfid");
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t6 = space();
    			attr_dev(p0, "class", "section-title svelte-fqmfid");
    			add_location(p0, file$1, 112, 12, 3269);
    			add_location(i, file$1, 113, 12, 3322);
    			set_style(div0, "display", "flex");
    			add_location(div0, file$1, 111, 10, 3229);
    			add_location(p1, file$1, 115, 10, 3370);
    			attr_dev(div1, "class", "line-container svelte-fqmfid");
    			add_location(div1, file$1, 110, 8, 3190);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, div0);
    ...
    function create_fragment$1(ctx) {
    	...
    	let div27;
    	let t36;
    	let each_value_2 = /*experiences*/ ctx[0];
    	validate_each_argument(each_value_2);
    	let each_blocks_2 = [];
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "class", "svelte-fqmfid");
    			add_location(img0, file$1, 3, 6, 85);
    			attr_dev(div0, "class", "vertical-line svelte-fqmfid");
    			add_location(div0, file$1, 4, 6, 138);
    			attr_dev(div1, "class", "section-divider svelte-fqmfid");
    			add_location(div1, file$1, 2, 4, 49);
    			add_location(p0, file$1, 8, 8, 260);
    			attr_dev(div2, "class", "dot svelte-fqmfid");
    			add_location(div2, file$1, 9, 8, 285);
    			attr_dev(div3, "class", "line svelte-fqmfid");
    			add_location(div3, file$1, 10, 8, 317);
    			attr_dev(div4, "class", "section-header svelte-fqmfid");
    			add_location(div4, file$1, 7, 6, 223);
    			attr_dev(p1, "class", "section-title svelte-fqmfid");
    			add_location(p1, file$1, 13, 8, 398);
    			add_location(p2, file$1, 14, 8, 460);
    			attr_dev(div5, "class", "line-container svelte-fqmfid");
    			...
    			attr_dev(div6, "class", "line-container svelte-fqmfid");
    			add_location(div6, file$1, 16, 6, 512);
    			add_location(p5, file$1, 20, 6, 667);
    			attr_dev(div7, "class", "section-content svelte-fqmfid");
    			add_location(div7, file$1, 6, 4, 187);
    			attr_dev(div8, "class", "section svelte-fqmfid");
    			...
    			attr_dev(img1, "class", "svelte-fqmfid");
    			add_location(img1, file$1, 26, 6, 803);
    			attr_dev(div9, "class", "vertical-line svelte-fqmfid");
    			add_location(div9, file$1, 27, 6, 850);
    			attr_dev(div10, "class", "section-divider svelte-fqmfid");
    			add_location(div10, file$1, 25, 4, 767);
    			add_location(p6, file$1, 31, 8, 972);
    			attr_dev(div11, "class", "dot svelte-fqmfid");
    			add_location(div11, file$1, 32, 8, 1011);
    			attr_dev(div12, "class", "line svelte-fqmfid");
    			add_location(div12, file$1, 33, 8, 1043);
    			attr_dev(div13, "class", "section-header svelte-fqmfid");
    			add_location(div13, file$1, 30, 6, 935);
    			attr_dev(div14, "class", "section-content svelte-fqmfid");
    			add_location(div14, file$1, 29, 4, 899);
    			attr_dev(div15, "class", "section svelte-fqmfid");
    			...
    			attr_dev(img2, "class", "svelte-fqmfid");
    			add_location(img2, file$1, 60, 6, 1801);
    			attr_dev(div16, "class", "vertical-line svelte-fqmfid");
    			add_location(div16, file$1, 61, 6, 1849);
    			attr_dev(div17, "class", "section-divider svelte-fqmfid");
    			add_location(div17, file$1, 59, 4, 1765);
    			add_location(p7, file$1, 65, 8, 1971);
    			attr_dev(div18, "class", "dot svelte-fqmfid");
    			add_location(div18, file$1, 66, 8, 1994);
    			attr_dev(div19, "class", "line svelte-fqmfid");
    			add_location(div19, file$1, 67, 8, 2026);
    			attr_dev(div20, "class", "section-header svelte-fqmfid");
    			add_location(div20, file$1, 64, 6, 1934);
    			attr_dev(div21, "class", "line-container svelte-fqmfid");
    			add_location(div21, file$1, 69, 6, 2070);
    			attr_dev(div22, "class", "section-content svelte-fqmfid");
    			add_location(div22, file$1, 63, 4, 1898);
    			attr_dev(div23, "class", "section svelte-fqmfid");
    			...
    			attr_dev(img3, "class", "svelte-fqmfid");
    			add_location(img3, file$1, 100, 6, 2881);
    			attr_dev(div24, "class", "vertical-line svelte-fqmfid");
    			add_location(div24, file$1, 101, 6, 2928);
    			attr_dev(div25, "class", "section-divider svelte-fqmfid");
    			add_location(div25, file$1, 99, 4, 2845);
    			add_location(p8, file$1, 105, 8, 3050);
    			attr_dev(div26, "class", "dot svelte-fqmfid");
    			add_location(div26, file$1, 106, 8, 3084);
    			attr_dev(div27, "class", "line svelte-fqmfid");
    			add_location(div27, file$1, 107, 8, 3116);
    			attr_dev(div28, "class", "section-header svelte-fqmfid");
    			add_location(div28, file$1, 104, 6, 3013);
    			attr_dev(div29, "class", "section-content svelte-fqmfid");
    			add_location(div29, file$1, 103, 4, 2977);
    			attr_dev(div30, "class", "section svelte-fqmfid");
    			attr_dev(div30, "id", "campus-involvement");
    			add_location(div30, file$1, 98, 2, 2795);
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*experiences*/ 1) {
    				each_value_2 = /*experiences*/ ctx[0];
    				validate_each_argument(each_value_2);
    				let i;
